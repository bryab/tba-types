 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classCELIO.html}
 */
declare namespace CELIO {
  ...
  /**
   * Inserts a file from a source location into a node's drawing
   * @param {QVariant} options Object containing two properties: src string type containing the path to the source file dst object type containing the target node and frame, specifying the drawing destination.
   * @returns {boolean}
   * @example
   * var success = CELIO.pasteImageFile({
   ...
   * });
   */
  function pasteImageFile(options: QVariant): boolean;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classabout.html}
 * @example
 * function printAbout() {
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classAction.html}
 * @example
 * function callAbout() {
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classBackdrop.html}
 * @example
 * {
 *     "position": {
 *         "x": -1030,
 ...
 * position.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classcolumn.html}
 * @example
...
*/
   ...
   * @param {string} columnName The name of the column.
   * @param {boolean} [removeSoundFile=false]
   * @returns {boolean}
   */
  function removeSoundColumn(
    columnName: string,
    removeSoundFile?: boolean
  ): boolean;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classcolumnMarkers.html}
 * @example
 ...
 * a parent of nodes.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classcompositionOrder.html}
 * @example
...
/**
 * The copyPaste JavaScript global object. Copy paste to/from templates. Note: 'Paste Special' options
 * will only take effect if activated beforehand, usePasteSpecial() for more details.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classcopyPaste.html}
 */
declare namespace copyPaste {
   ...
   * frames pasted.
   * Warning: This paste option will only take effect after usePasteSpecial() is called with 'true',
...
* Warning: This paste option will only take effect after usePasteSpecial() is called with 'true',
* otherwise the default value will be used.
* @param {string} mode The Color Palette Option mode, acceptable strings are:
"DO_NOTHING" - Paste does not modify the palette list of the destination element.
"REUSE_PALETTES" - Paste will copy the palette if a file with the same name does not exists at the destination.
"COPY_AND_OVERWRITE_EXISTING_PALETTES" - Paste will overwrite any palette file at the destination.
"COPY_AND_CREATE_NEW_PALETTES" - Paste will not overwrite palette files at the destination, it will create new files with unique names.
"COPY_AND_CREATE_NEW_PALETTES_IN_ELEMENT_FOLDER" - Similar to COPY_AND_CREATE_NEW_PALETTES, but in the destination element directory, instead of the orignal location.
"COPY_PALETTE_AND_MERGE_COLOURS" - Paste will combine the colours of the two palettes (adds unexesting colours to the destination palette).
"COPY_PALETTE_AND_UPDATE_COLOURS" - Paste will update the colours in the destination palettes with the ones from the source palette.
- "LINK_TO_ORIGINAL" - Paste will not copy the palette file, it will instead add/link the original palette to the element's palette list.
"COPY_SCENE_PALETTE_AND_MERGE_COLOURS" - Paste will combine the two palettes and add unexisting colours to the destination palette.
"COPY_SCENE_PALETTE_AND_UPDATE_COLOURS" - Paste will combine the two palette and overwrite any colours in the destination palette.
* @returns {void}
*/
...
* Warning: This paste option will only take effect after usePasteSpecial() is called with 'true',
* otherwise the default value will be used.
* @param {"DO_NOTHING" | "ADD_OR_REMOVE_EXPOSURE" | "UPDATE_PIVOT"} mode The Drawing Action mode, acceptable strings are:
"DO_NOTHING" - The paste operation will not affect the drawings.
"ADD_OR_REMOVE_EXPOSURE" - The paste operation will add the necessary exposure on the destination, replacing any prewvious exposure.
"UPDATE_PIVOT" - The paste operation will only affect the drawing pivots on the destination.
* @returns {void}
*/
  ...
  /**
* PasteSpecial Structure value. Default value is "ALWAYS_CREATE" if "LIBRARY_PASTE_CREATE_NEW_DRAWING"
* is set, otherwise it is "ONLY_CREATE_IF_DOES_NOT_EXIST".
* Warning: This paste option will only take effect after usePasteSpecial() is called with 'true' and
* the setPasteSpecialDrawingAction() is set to "ADD_OR_REMOVE_EXPOSURE", otherwise the default value
* will be used.
* @param {"NEVER_CREATE"|"ONLY_CREATE_IF_DOES_NOT_EXIST"|"ALWAYS_CREATE"|"ALWAYS_CREATE_AND_VERSION_IF_NECESSARY"} mode The Drawing File mode, acceptable strings are:
"NEVER_CREATE" - Only pastes the timing (text) of the drawing (mostly useful for Xsheet pasting).
"ONLY_CREATE_IF_DOES_NOT_EXIST" - Pasted drawings which already exist on that element will only create new exposures of those drawings, otherwise new drawings will be created.
"ALWAYS_CREATE" - Always creates new drawings on the paste destination (it automatically generates unique names).
"ALWAYS_CREATE_AND_VERSION_IF_NECESSARY" - Deprecated
"REPLACE_EXISTING" - Always paste drawings with their original name, if a drawing with that same name already exists on the destination, it will be overwritten.
* @returns {void}
*/
...
* Sets the paste special elementtiming mode for calls to pasteTemplateIntoScene Warning: This paste
* option will only take effect after usePasteSpecial() is called with 'true', otherwise the default
* value will be used.
* @param {string} mode The Timing Column mode, acceptable strings are:
ELEMENT_AS_ELEMENT_AND_TIMING_AS_TIMING - Paste will create the read node as a timing or an element (for the timing case, it will create a folder under timings subdirectory)
ALL_DRWGS_AS_ELEMENTS - Paste will convert all read timing nodes to element nodes (copying all the files).
ALL_DRWGS_LINKED_THRU_TIMING_COLS - Paste will convert all elements nodes to timing nodes (will not copy the drawings files).
* @returns {void}
*/
   ...
   * the copied content. Set this to a value >= 1 to specific the frame to use as a starting frame.
   * Warning: This paste option will only take effect after usePasteSpecial() is called with 'true',
   * otherwise the default value will be used.
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classDrawing.html}
 * @example
...
declare namespace Drawing {
   ...
   * @returns {QScriptValue}
   */
  function filepath(elementId: int, drawingName: string): QScriptValue;

  /**
   * Returns a timing that does not exist in the element and could be passed to importDrawing().
   * @param {int} elementId The unique id of the element.
   * @param {string} baseTiming The base drawing name. Can be empty.
   * @returns {string}
   */
  function generateUniqueTiming(elementId: int, baseTiming: string): string;

  /**
   * @param {int} elementId
   * @returns {string}
   */
  function generateUniqueTiming(elementId: int): string;

  /**
   * Imports a new drawing inside an element and assigns it the timing passed in argument. If the timing
   * exists, the file will be replaced.
   * @param {int} elementId The unique id of the element.
   * @param {string} timing The proposed drawing name.
   * @param {QScriptValue} filepath The file path to import.
   * @returns {boolean}
   * @example
   * // This piece of code imports a specified drawing in the selected read element
   * // at the current frame. It makes sure to create a unique exposure name for the drawing.
   * var filename = "/tmp/myDrawing.tvg";
   * var n = selection.selectedNode(0);
   * if (!n) return;
   *
   * var elemId = node.getElementId(n);
   * var newTiming = Drawing.generateUniqueTiming(elemId);
   * scene.beginUndoRedoAccum("Import drawing: " + filename);
   * Drawing.importDrawing(elemId, newTiming, filename);
   * var cid = node.linkedColumn(n, "DRAWING.ELEMENT");
   * column.setEntry(cid, 1, frame.current(), newTiming);
   * scene.endUndoRedoAccum();
   */
  function importDrawing(
    elementId: int,
    timing: string,
    filepath: QScriptValue
  ): boolean;
   ...
   * @param {int} elementId The unique id of the element.
   * @param {int} drawingLayerIndex The drawing layer index (if the index is 0 it will return the default drawing layer name, which is empty).
   * @returns {string}
   */
  function layer(elementId: int, drawingLayerIndex?: int): string;
   ...
   * @returns {int}
   */
  function numberOfLayers(elementId: int): int;
}

/**
 * The DrawingTools JavaScript global object. Get information about the currently selected drawing.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classDrawingTools.html}
 * @example
...
declare namespace DrawingTools {
   ...
   * @returns {void}
   */
  function clearArtLayer(drawingKey: QScriptValue, artLayer: int): void;
   ...
   * sourceDrawingKey : A drawing key, built from { ElementID : id, exposure : "drawingName"}, or {node:
   * "Qualified_name", frame : i}
   * sourceArtLayer : The artlayer index defining the source art layer that will be copied. [0, 1, 2, 3]
   * targetDrawingKey : A drawing key, built from { ElementID : id, exposure : "drawingName"}, or {node:
   * "Qualified_name", frame : i}
   * targetArtLayer : The artlayer index defining the source art layer that will be copied. [0, 1, 2, 3]
   * @param {QScriptValue} sourceDrawingKey
   * @param {int} sourceArtLayer
   * @param {QScriptValue} targetDrawingKey
   * @param {int} targetArtLayer
   * @returns {void}
   */
  function copyArtLayer(
    sourceDrawingKey: QScriptValue,
    sourceArtLayer: int,
    targetDrawingKey: QScriptValue,
    targetArtLayer: int
  ): void;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classelement.html}
 * @example
 * function addElement() {
...
declare namespace element {
  ...
  /**
   * This function returns true if the element specified by elementId is contained in a virtual file
   * system.
   * @param {int} elementId The unique id of the element.
   * @returns {boolean}
   */
  function isPacked(elementId: int): boolean;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classexporter.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classFileDialog.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classfileMapper.html}
 */
declare namespace fileMapper {
  ...
  /**
   * Converts a string-encoded VFS Path to an object.
   * @param {QScriptValue} v
   * @returns {QScriptValue}
   */
  function toVFSPath(v: QScriptValue): QScriptValue;

  /**
   * Converts a VFS Path to string-encoded representation.
   * @param {QScriptValue} v
   * @returns {QScriptValue}
   */
  function VFSPathToString(v: QScriptValue): QScriptValue;
}
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classframe.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classfunc.html}
 * @example
...
declare namespace func {
  ...
  /**
   * Returns the lower and upper key values that bound the provided keyframe.
   * @param {string} columnName The name of the column.
   * @param {double} frame The frame for which the bounds are determined.
   * @returns {QScriptValue}
   */
  function getKeyBoundValues(columnName: string, frame: double): QScriptValue;

  /**
   * Return a list of [Frame, Value] pairs for the column's keyframes.
   * @param {string} columnName The name of the column.
   * @returns {QScriptValue}
   */
  function getKeyValues(columnName: string): QScriptValue;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classInput.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classKeyModifiers.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classlibrary.html}
 */
declare namespace library {
   ...
   * @returns {string}
   */
  function addFolder(folderName: string, parentFolderPath: string): string;

  /**
   * close the library folder. This function cannot be used in batch mode.
   * @param {string} libraryRoot The name of the root folder in the library to remove.
   * @returns {boolean}
   */
  function closeLibrary(libraryRoot: string): boolean;

  /**
   * Delete items from the library. This function cannot be used in batch mode. WARNING: If the item is a
   * an actual folder in your filesystem that has been opened in the library, it will delete this item
   * from your filesystem.
   * @param {StringList} pathsOfItemsToRemove Am array of the item paths to remove from the library, in the form of "folder1/folder2/file1". They can be files or folders.
   * @returns {void}
   */
  function deleteItems(pathsOfItemsToRemove: StringList): void;
   ...
   * @param {string} itemPath The path of the item in library, in the form of "folder1/folder2/file1". The item can be a file or folder.
   * @returns {boolean}
   */
  function itemExists(itemPath: string): boolean;

  /**
   * Move items like folders or files to another location in the library. This function cannot be used in
   * batch mode.
   * @param {StringList} srcItemPaths An array of item paths to move, in the form of "folder1/folder2/file1". They can be files or folders. The source folders can only come from the Audio bin. The items must exist.
   * @param {string} dstFolderPath The path of the folder in to move the item to, in the form of "folder1/folder2". The folder must exist.
   * @returns {void}
   */
  function moveItems(srcItemPaths: StringList, dstFolderPath: string): void;
   ...
   * @param {string} filesystemPath The path of the folder in the filesystem to open in the library.
   * @returns {boolean}
   */
  function openLibrary(filesystemPath: string): boolean;

  /**
   * Rename a file or folder in the library. This function cannot be used in batch mode.
   * @param {string} itemPath The path of the item in library, in the form of "folder1/folder2/file1". The item can be a file or folder. The item must exist.
   * @param {string} newName The new name of the item.
   * @returns {boolean}
   */
  function renameItem(itemPath: string, newName: string): boolean;
}

/**
 * The MessageBox JavaScript class. A simplified version of the MessageBox Qt dialog.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classMessageBox.html}
 * @example
 ...
 * window.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classMessageLog.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classMovieImport.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classnode.html}
 * @example
 * function compose() {
...
declare namespace node {
  ...
  /**
   * Returns the Attribute of the given node. The attribute value is for the given frame. Returns null if
   * no attribute with the provided name exists for that node.
   ...
   * var fovAttr = node.getAttr(cameraNode, frame.current(), "FOV");
   *
   * if (fovAttr) {
   *     var FOV = fovAttr.doubleValue();
   ...
   * @param {boolean} [link=true] - Auto connect the moved node to the destination’s Multiport-In/Out.
   * @returns {string}
   * @example
   * node.moveToGroup("Top/MyGroup/Drawing", "Top/MyGroup/MyNewGroup");
   */
  function moveToGroup(node: string, groupName: string, link?: boolean): string;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classPaletteManager.html}
 * @example
...
declare namespace PaletteManager {
   ...
   * @param {boolean} protectSceneVersions If true, checks all the other versions of the scene for used data, and protects against deleting it, even if the data is unused on the current scene.
   * @returns {void}
   */
  function removeUnusedFiles(
    deleteFiles: boolean,
    protectSceneVersions: boolean
  ): void;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classPaletteObjectManager.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classPenstyleManager.html}
 * @example
...
declare namespace PenstyleManager {
  ...
  /**
   * Attempts to import a penstyle list from a file (e.g.: .xml, .abr).
   * @param {string} filepath
   * @returns {void}
   */
  function importPenstyleListFromFile(filepath: string): void;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classpreferences.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classrender.html}
 * @example
...
declare namespace render {
  ...
  /**
   * Render a set of specific nodes in a set of frames.
   * After a frame is rendered, a frameReady signal will be emitted. Connect to it to save the rendered
   * frames.
   * @param {QScriptValue} nodeNameList list of nodes to render
   * @param {QScriptValue} frameList The set of frames to render, which may be unsorted e.g. [1,3,2,4]
   * @returns {void}
   */
  function renderNodes(
    nodeNameList: QScriptValue,
    frameList: QScriptValue
  ): void;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classscene.html}
 * @example
 * function setScene() {
...
declare namespace scene {
  ...
  /**
   * Build a VFS file path in the project's vdb file.
   * @param {string} relativePath
   * @param {int} [repo=SCR_VFS_Enum::PROJECT]
   * @returns {QScriptValue}
   */
  function buildVFSPath(relativePath: string, repo?: int): QScriptValue;
  ...
  /**
   * Clears the cached files contained in the vdb of the project.
   * @returns {boolean}
   */
  function clearVFSCache(): boolean;
   ...
   * @returns {string}
   */
  function currentProjection(): string;
  ...
  /**
   * Returns the whether vector TVG files will store recovery textures.
   * @returns {boolean}
   */
  function getVectorFormatStoresRecoveryTextures(): boolean;
  ...
  /**
   * Will return true if the scene has an active VFS container.
   * @returns {boolean}
   */
  function isCompacted(): boolean;

  /**
   * Returns true if the current project will be compressed when saving. This does not mean the current
   * project file on disk is compressed, because the preferences between the load and now could have
   * changed
   * @returns {boolean}
   */
  function isCurrentProjectCompressed(): boolean;
  ...
  /**
   * This function sets the scene projection.
   * @param {string} projectionName Set the scene projectionName. Either "Orthographic" or "Perspective"
   * @returns {boolean}
   */
  function setProjection(projectionName: string): boolean;
  ...
  /**
   * Changes whether vector TVG files will store recovery textures.
   * When set to false, only a thumbnail of the recovery texture is stored in the TVG.
   * @param {boolean} enabled
   * @returns {void}
   */
  function setVectorFormatStoresRecoveryTextures(enabled: boolean): void;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSceneOffline.html}
 */
 ...
 * The ScriptNode class provides special methods for interacting with script nodes, in specific, script
 * nodes used for external rendering.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classScriptNode.html}
 */
declare namespace ScriptNode {
  /**
   * Returns a list of Params3d objects, one element per each transversal paths to the script node from
   * the target display node. Each path may contain specific transformations, and subnode animation
   * transformations, particular to it.
   * @param {string} scriptNodeName The name of a script node (Note: E.g. a Blender/Maya script node).
   * @param {double} [frame=0.0] The frame on which to get the contexts. If left empty, the current frame will be used.
   * @param {string} [display=""] The name of the target display node. If left empty, the default display will be used.
   * @returns {QScriptValue}
   */
  function inputContexts(
   ...
   * @returns {string}
   */
  function readNodePath(scriptNodeName: string): string;
}

/**
 * The selection JavaScript global object. Retrieve information about the nodes or columns that are
 * selected.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classselection.html}
 * @example
 ...
 * an example.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classsound.html}
 * @example
...
/**
 * The SWFExporter JavaScript global object.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSWFExporter.html}
 */
declare namespace SWFExporter {
  /**
   * Creates an object suitable to pass to the SWFExporter.exportToFile function.
   * @returns {QScriptValue}
   * @example
   * var settings = SWFExporter.createSettings();
   * settings.outputFile = "myMovie.swf";
   * SWFExporter.exportToFile(settings);
   */
  function createSettings(): QScriptValue;

  /**
   * Exports the current scene in SWF format. There are many options that can be passed in that args
   * object.
   ...
   * settings = {
   *     "outputFile": "", // Set this to the desired path
   *     "compress": false, // compress the resulting file
   *     "protect": false, // SWF edition protection flag
   *     "display": "Top/Display", // The name of the display
   *     "firstFrame": 1,
   *     "lastFrame": 60,
   *     "fps": 24, // The framerate. Has to be rounded to an integer.
   *     "preservePencilLines": true, // Will not convert pencil to brushes in deformations.
   *     "nonScalablePencilLines": true, // Export the pencil lines as non-scalable. They will keep the same width even when the object comes closes to the camera.
   *     "fixNonScalablePencilLinesForAnimate": false, // If the export is for Adobe Animate, set this to true if  nonScalablePencilLines is true. Otherwise, the pencil lines will be 20x too small.
   *     "showProgress": true, // If set to true, no progress bar will appear. This is always false in batch mode
   *     "silent": true, // If set to false, the final confirmation dialog with the report option will not appear. Always false in batch mode.
   *     // These are effect export flags
   *     "exportRadialBlur": true,
   *     "exportColourOverride": true,
   *     "exportTone": true,
   *     "exportShadow": true,
   *     "exportTransparency": true,
   *     "exportColourScale": true,
   *     "exportDirectionalBlur": true,
   *     "exportHighlight": true,
   *     "exportGlow": true,
   *     "exportBlending": true
   * };
   * // All the filters (exportRadialBlur, exportColourOverride, etc) can be enabled at once by using:
   * settings.exportAllEffects = true;
   * // They can also be all disabled by:
   * settings.exportNoEffects = true;
   * // If both exportAllEffects and exportNoEffects are true, exportNoEffects has precedence.
   * SWFExporter.exportToFile(settings);
   */
  function exportToFile(args: QScriptValue): boolean;
}

/**
 * The Synclayer JavaScript global object. Provides utilities for sync and unsync drawing layers.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSyncLayer.html}
 */
 ...
 * Terminal.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSystem.html}
 * @example
...
declare namespace System {
  /**
   * Get the value of 7zip path in the system.
   * @returns {string}
   */
  function find7Zip(): string;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classTimeline.html}
 * @example
...
declare namespace Timeline {
   ...
   * @returns {boolean}
   */
  function layerEnabled(layerIndex: int): boolean;
   ...
   * @returns {boolean}
   */
  function layerIsAttribute(layerIndex: int): boolean;
   ...
   * @returns {QObject}
   */
  function layerToAttribute(layerIndex: int): QObject;
   ...
   * @returns {QList<QObject>}
   */
  function selectionToAttributeList(): QList<QObject>;

  /**
   * Creates a list of columns from the selected timeline layers.
   * @returns {StringList}
   */
  function selectionToColumnList(): StringList;

  /**
   * Creates a list of nodes from the selected timeline layers.
   * @returns {StringList}
   */
  function selectionToNodeList(): StringList;
   ...
   * @returns {boolean}
   */
  function selIsAttribute(selectionIndex: int): boolean;
   ...
   * @returns {QObject}
   */
  function selToAttribute(selectionIndex: int): QObject;
   ...
   * @param {int} layerIndex The layer index in the timeline layer.
   * @param {boolean} flag The enable/disable status of the specified layer
   * @returns {boolean}
   */
  function setLayerEnabled(layerIndex: int, flag: boolean): boolean;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classTimelineMarker.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classToolProperties.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classUiloader.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classview.html}
 * @example
 * function viewScript() {
...
declare namespace view {
  ...
  /**
   * Returns the centre of the active node view.
   * @param {string} viewName The name of the view to get the position of.
   * @returns {QPoint}
   */
  function nodeViewCoord(viewName: string): QPoint;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classwaypoint.html}
 * @example
 ...
 * selection.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classxsheet.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classComboBox.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classDateEdit.html}
 * @example
 * var myDialog = new Dialog();
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classLineEdit.html}
 * @example
 * var myDialog = new Dialog();
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classNumberEdit.html}
 * @example
 * var myDialog = new Dialog();
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSlider.html}
 * @example
 * var mySlider;
 *
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSpinBox.html}
 * @example
 * var myDialog = new Dialog();
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classTimeEdit.html}
 * @example
 * var myDialog = new Dialog();
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classWidgetBase.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classButtonWidget.html}
 * @example
 ...
 * Create this widget to add a floating Master Controller in the camera view:
 * Make sure to setup the Master Controller node specifications properly. e.g.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classCheckboxWidget.html}
 * @example
 * Controller.onShowControl = function() {
 *     MessageLog.trace("\n\n\n");
 *     MessageLog.trace(" ---------------------------------------------------------------------------");
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classCustomWidget.html}
 * @example
 ...
 * Create this widget to add a floating Master Controller in the camera view:
 * Make sure to setup the Master Controller node specifications properly. e.g.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classLabelWidget.html}
 * @example
 * Controller.onShowControl = function() {
 *     MessageLog.trace("\n\n\n");
 *     MessageLog.trace(" ---------------------------------------------------------------------------");
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classLine2dDisplayWidget.html}
 * @example
 * Controller.onShowControl = function() {
 *         Controller.controls = [];
 *
 ...
 * current frame.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classPoint2dWidget.html}
 * @example
 * Controller.onShowControl = function() {
 *     Controller.controls = [];
 *
 ...
 * value).
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classRotation3dWidget.html}
 * @example
 * Controller.onShowControl = function() {
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classRotationXWidget.html}
 * @example
 * Controller.onShowControl = function() {
 *     Controller.controls = [];
 *
 ...
 * to the widget.
 * In the callback function, convert the widget value into an action.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classRotationYWidget.html}
 * @example
 * Controller.onShowControl = function() {
 *     Controller.controls = [];
 ...
 * to the widget.
 * In the callback function, convert the widget value into an action.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classRotationZWidget.html}
 * @example
 * Controller.onShowControl = function() {
 *     Controller.controls = [];
 *
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSliderWidget.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classTranslationXWidget.html}
 * @example
 * Controller.onShowControl = function() {
 ...
 * This example shows how to apply the difference in translation of a translation widget on an
 * arbitrary peg in the scene.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classTranslationYWidget.html}
 * @example
 * Controller.onShowControl = function() {
 *     // Set the widget properties at its creation.
 ...
 * This example shows how to apply the difference in translation of a translation widget on an
 * arbitrary peg in the scene.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classTranslationZWidget.html}
 * @example
 * Controller.onShowControl = function() {
 *     // Set the widget properties at its creation.
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classAttribute.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classAttrState.html}
 * @example
 ...
 * Also see Palette.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classBaseColor.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classColor.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classTexture.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classCel.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classColorOverride.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classColorRGBA.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classColorType.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classCompositionItem.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classConstants.html}
 * @example
 ...
 * Controller script.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classController.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classCopyOptions.html}
 * @example
 ...
 * Use with DateEdit.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classDateEditEnum.html}
 * @example
 ...
 * etc.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classDir.html}
 * @example
 * var dir = new Dir;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classDirSpec.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classDragContext.html}
 * @example
 * var drag_offset = new Vector3d;
 *
 * function onDragStart(context) {
 ...
 * method.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classDragObject.html}
 * @example
 * var myCopyOptions = copyPaste.getCurrentCreateOptions();
 * myCopyOptions.addModelsDir = false;
 *
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classDrawingToolParams.html}
 * @example
 * var params = new DrawingToolParams;
 * params.applyAllDrawings = true;
 * DrawingTools.extractCenterline(DrawingTools.lineArt, DrawingTools.colourArt, params);
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classFile.html}
 * @example
...
declare class File extends QObject {
  /**
   * @param {VFS_Path} filename The path to the file.
   * @returns {void}
   */
  ...
  /**
   * Returns the files contained in the.
   * @returns {StringList}
   */
  public listFiles(): StringList;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classFileAccess.html}
 * @example
 * var file = new File(filePath);
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classFileIOType.html}
 */
 ...
 * name of a file as an argument. The PermanentFile can also take the result of scene.buildVFSPath in
 * argument.
 * The TemporaryFile takes an extension as an argument, an returns a temporary file with that
 * extension. The temporary file and its containing directory will be deleted on exit. The
 * TemporaryFile CANNOT take the result of scene.buildVFSPath in argument.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classFileWrapper.html}
 * @example
...
declare class FileWrapper extends QObject {
  ...
  /**
   * Retrieves the full absolute file path.
   * @returns {string}
   */
  ...
  /**
   * If the File is a folder, will list the entries in that folder
   * @returns {StringList}
   */
  public listFiles(): StringList;
  ...
  /**
   * Corrects the current path of the file to use native separators. The name of file can not be changed
   * if there is an open stream.
   * @returns {boolean}
   */
  public toNativePath(): boolean;
 ...
 * bar.
 * Example usage - Render the layout for all frames:
 * The Layout will be exported for all frames requested.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classLayoutExport.html}
 * @example
 * function ExportLayout() {
 *     var le = new LayoutExport;
 *     var params = new LayoutExportParams;
 *
 *     params.initializeToDefaultParams();
 *
 *     var showDialog = false; //If desired, we can show the user Dialog in the GUI. Cannot be used in batch/commandline.
 *     if (showDialog)
 *         if (!le.execDialog(params, true, true, "Export Layout"))
 *             return; //Cancelled
 *
 *     //Calculate the zoom scale required for the minimal layout size based on the camera positions in the scene.
 *     le.calculateAndApplyZoomScale(params);
 *
 *     params.exportCameraFrame = true;
 *
 *     params.fileDirectory = "C:/output/folder";
 *
 *     var range = frame.numberOf();
 *
 *     var progressDialog = new QProgressDialog(null);
 *     progressDialog.setRange(0, range + 1);
 *     progressDialog.windowModality = Qt.ApplicationModal;
 *     progressDialog.show();
 *
 *     for (var i = 1; i <= range; ++i) {
 *         params.frame = i;
 *         var retval = le.addRender(params);
 *         if (retval == true) {
 *             if (le.save(params)) {
 *                 le.saveXli(params);
 *             }
 ...
 *     }
 *
 *     progressDialog.setValue(range + 1);
 *     progressDialog.hide();
 * }
 */
declare class LayoutExport extends QObject {
  ...
  /**
   * Calculate and apply the zoom scale according to the camera positions in the scene.
   * @param {LayoutExportParams} params The layout export parameters of the dialog when the dialog is closed. Passed as a reference.
   * @returns {void}
   */
  public calculateAndApplyZoomScale(params: LayoutExportParams): void;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classLayoutExportParams.html}
 * @example
 *  var le = new LayoutExport;
 *  var params = new LayoutExportParams;
 *
...
declare class LayoutExportParams extends QObject {
  /**
   * Initialize the default params to the default values stored in the preferences.
   * @returns {void}
   */
  public initializeToDefaultParams(): void;
   ...
   * @returns {double}
   */
  commonDefaultBox_xmax: double;

  /**
   * @returns {double}
   */
  commonDefaultBox_xmin: double;

  /**
   * @returns {double}
   */
  commonDefaultBox_ymax: double;

  /**
   * @returns {double}
   */
  commonDefaultBox_ymin: double;

  /**
   * @returns {double}
   */
  commonSceneBox_xmax: double;

  /**
   * @returns {double}
   */
  commonSceneBox_xmin: double;

  /**
   * @returns {double}
   */
  commonSceneBox_ymax: double;

  /**
   * @returns {double}
   */
  commonSceneBox_ymin: double;

  /**
   * @returns {int}
   */
  customScopeFirst: int;
   ...
   * @returns {boolean}
   */
  enableBorderScale: boolean;

  /**
   * @returns {boolean}
   */
  enableMaxImageSize: boolean;

  /**
   * @returns {boolean}
   */
  enableZoomScale: boolean;

  /**
   * @returns {boolean}
   */
  expandRenderAreaToDrawing: boolean;
   ...
   * @returns {boolean}
   */
  exportCameraFrameLabel: boolean;
  ...
  /**
   * The frame that will be rendered. A value of -1 will render the current frame in the scene (GUI
   * only).
   * @returns {int}
   */
  frame: int;
   ...
   * @returns {boolean}
   */
  includeDrawingBox: boolean;

  /**
   * @returns {boolean}
   */
  keepColorCardVisible: boolean;

  /**
   * @returns {boolean}
   */
  keepLockedElementsVisible: boolean;
  ...
  /**
   * Deprecated. Use commonSceneBox_xmin instead.
   * See LayoutExportParams::commonSceneBox_xmin.
   * @returns {double}
   */
  sceneBox_x1: double;

  /**
   * Deprecated. Use commonSceneBox_xmax instead.
   * See LayoutExportParams::commonSceneBox_xmax.
   * @returns {double}
   */
  sceneBox_x2: double;

  /**
   * Deprecated. Use commonSceneBox_ymin instead.
   * See LayoutExportParams::commonSceneBox_ymin.
   * @returns {double}
   */
  sceneBox_y1: double;

  /**
   * Deprecated. Use commonSceneBox_ymax instead.
   * See LayoutExportParams::commonSceneBox_ymax.
   * @returns {double}
   */
  sceneBox_y2: double;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classMatrix4x4.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classModel3d.html}
 */
 ...
 * frame number.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classNodeState.html}
 * @example
 * //Create a snapshot of "Top/Master-P" position, rotation and scale node attributes at frames 1 and 9,
 * var pegDataA = new NodeState("Top/Master-P", 1, ["POSITION", "SCALE", "ROTATION"]);
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classPalette.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classPaletteList.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classPaletteListType.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classPaletteLocation.html}
 * @example
 * var envPath = PaletteObjectManager.Constants.Location.ENVIRONMENT;
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classPaletteLocator.html}
 */
declare class PaletteLocator extends QObject {
   ...
   * location. That works when palettes are not in a container.
   * @param {int} location One of the PaletteLocation constants.
   * @param {int} elementId If location is PaletteLocation.ELEMENT, the element id
 ...
 * The Params3dWrapper JavaScript class which mimics the behaviour of SM_Cel3dWrapper but on the script
 * interface.
 * The Params3d class provides a structure availabe from scripting containg the Cel3d data and a
 * partially built parameter structure, internal to the cel3d, without the necessity of triggering a
 * render.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classParams3d.html}
 */
declare class Params3d extends QObject {
  /**
   * Returns the camera component of the Cel3d transformation matrix.
   * @returns {Matrix4x4}
   */
  public cameraMatrix(): Matrix4x4;
   ...
   * @returns {boolean}
   */
  public isSubnodeLocallyVisible(subnodeName: string): boolean;
   ...
   * @returns {Matrix4x4}
   */
  public transformationForSubnode(subnodeName: string): Matrix4x4;

  /**
   * @returns {boolean}
   */
  public useFileUnits(): boolean;
}

/**
 * The JavaScript class for getting or setting the model directory, the scan files and the default
 * camera name flags when pasting. Obtain from the copyPaste global object. Warning: Some of these
 * properties will only be applied if the Paste Special option is active.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classPasteOptions.html}
 * @example
...
declare class PasteOptions extends QObject {
  ...
  /**
   * Property setting the colour palette paste mode, read copyPaste::setPasteSpecialColorPaletteOption()
   * for more details on how to activate this property.
   * @returns {string}
   */
  ...
  /**
   * Property setting the drawing file mode, read copyPaste::setPasteSpecialDrawingFileMode() for more
   * details on how to activate this property.
   * @returns {string}
   */
  drawingFileMode: string;

  /**
   * Property setting the drawing paste mode, read copyPaste::setPasteSpecialDrawingAction() for more
   * details on how to activate this property.
   * @returns {string}
   */
  ...
  /**
   * Property setting the element mode, read copyPaste::setPasteSpecialElementTimingColumnMode() for more
   * details on how to activate this property.
   * @returns {string}
   */
  elementMode: string;
  ...
  /**
   * Property setting if the paste should force the creation of keyframes at the beggining and at the
   * ending of the pasted exposure. Default value is false.
   * @returns {boolean}
   */
  ...
  /**
   * The frame from which to start the deletion range from. Default value is 0, indicative that the
   * selection is empty.
   * @returns {int}
   */
  ...
  /**
   * The number of frames from the source of the copy-paste. Default value is 0, indicative that the
   * selection is empty.
   * @returns {int}
   */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classPoint2d.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classPoint3d.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classProcess2.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classProcessManager.html}
 */
 ...
 * a 3-D object.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classQuaternion.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classRemoteCmd.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classRigState.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSceneChangeNotifier.html}
 * @example
 * Controller.onShowControl = function() {
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSCR__NetworkSessionSocketMgrWrapper.html}
 * @example
 * // Bind a new socket
 ...
 *         // Accept client, with a 5 seconds timeout and support a queue of 10 messages
 *         clientSocketId = SessionSocketMgr.acceptAtPort(serverPort, 5000, 10);
 *         if (clientSocketId < 0)
 *             MessageLog.trace("Client accept timeout!");
 *
 *         // Validate the connection
 *         if (SessionSocketMgr.clientSocketConnected(clientSocketId)) {
 *             // Exchange message
 ...
 *             }
 *         } else {
 *             MessageLog.trace("Client failed to connect!");
 *         }
 *
 *         client.disconnect()
 *     } else {
...
declare class SCR_NetworkSessionSocketMgrWrapper extends QObject {
  /**
   * Accepts a socket on the given bound port, returning a generated ID for it (-1 being the failure
   * value). Note: once a socket connection is accepted, its state should be checked with
   * clientSocketConnected(). Note: once a socket connection is severed, it must be removed using
   * removeSocketConnection() in order to be accepted again.
   * @param {int} port
   * @param {int} timeoutMS
  ...
  /**
   * Creates a new bound port.
   * @returns {int}
   */
  public bindNewPort(): int;

  /**
   * Returns the list of all bound ports.
   * @returns {QScriptValue}
   */
  public boundPorts(): QScriptValue;

  /**
   * Returns true if an accepted connection is still valid.
  ...
  /**
   * Unbinds all of the ports, closing all of the active communications.
   * @returns {void}
   */
  public closeAll(): void;

  /**
   * Clears all of the messages currently being stored for a given socket.
   * @param {int} clientSocketId
   * @returns {void}
   */
  ...
  /**
   * Receives all of the messages currently being stored for a given socket.
   * @param {int} clientSocketId
   * @returns {QScriptValue}
   */
  ...
  /**
   * Receive messages from an accepted socket.
   * @param {int} clientSocketId
   * @param {int} timeoutMS
   * @returns {boolean}
   */
  ...
  /**
   * Closes the connection between an accepted socket, and its bound port.
   * @param {int} clientSocketId
   * @returns {void}
   */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSCR__ProcessManagerWrapper.html}
 * @example
 * // Build command line
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSCR__VFS__Enum.html}
 * @example
 ...
 * // "filename":"myLocalPath/file.txt"}
 */
declare class SCR_VFS_Enum extends QObject {}
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSessionChangeNotifier.html}
 */
...
/**
 *
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSessionSocketManager.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSubnodeData.html}
 */
 ...
 * in the scripting environment.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classVector2d.html}
 */
 ...
 * instantiated in the scripting environment.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classVector3d.html}
 */
 ...
 * generate.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classWriteNode.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classdeformation.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classWebCCExporter.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classButton.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classCheckBox.html}
 * @example
 * var myDialog = new Dialog();
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classDialog.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classGroupBox.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classLabel.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classRadioButton.html}
 * @example
 * var myDialog = new Dialog();
...
/**
 * The ScrollArea JavaScript class. A simplified version of the ScrollArea Qt widget.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classSCRIPT__QSScrollArea.html}
 */
declare class SCRIPT_QSScrollArea extends SCRIPT_QSWidget {}

/**
 * The TextEdit JavaScript class. A simplified version of the TextEdit Qt widget.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classTextEdit.html}
 * @example
 * var myDialog = new Dialog();
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classspecialFolders.html}
 * @example
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/classExportVideoDlg.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/namespaceDeformationUtils.html}
 */
...
/**
 *
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/namespaceMath.html}
 */
declare namespace Math {}

/**
 *
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/script/namespaceSubnode.html}
 */
declare namespace Subnode {
  /**
   * Delete transformation timeline keyframes from a SubNodeMotion node.
   * This will delete timeline keyframes from the SubNodeMotion node. The imported transformation data
   * will not be affected.
   * @param {string} node The path to the SubNodeMotion node.
   * @returns {boolean}
   */
  function deleteKeyframes(node: string): boolean;

  /**
   * Delete the transformation data from a SubNodeMotion node.
   * This will delete the transformation data from the SubNodeMotion node. Timeline keyframes will be
   * deleted as well.
   * @param {string} node The path to the SubNodeMotion node.
   * @returns {boolean}
   */
  function deleteTransformations(node: string): boolean;

  /**
* Export transformation data from scene nodes to a USD (Universal Scene Description) or Autodesk Maya
* ATOM (Animation Transfer Object Model) file.
* Example use:
* @param {string} filePath File path for the USD or ATOM file to export transformation data to. The file type is determined from the file extension (e.g. ".usd" or ".atom")
* @param {Object} [options={}] (Optional) A dictionary object containing options for the export.
Accepted options are:
Property  Type  Description
overwriteExistingFile  Boolean  (Optional) Overwrite file if it already exists. Default is false.
* @returns {boolean}
* @example
* var ok = Subnode.exportPegTransformations("/assets/animation.atom", {
*     overwriteExistingFile: true
* });
* if (!ok)
*     MessageLog.trace("Peg transformations export failed!");
*/
  function exportPegTransformations(
    filePath: string,
    options?: {
      /**
       * (Optional) Overwrite file if it already exists. Default is false.
       */
  ...
  /**
   * Export transformation data from a SubNodeMotion node to a USD (Universal Scene Description) or
   * Autodesk Maya ATOM (Animation Transfer Object Model) file.
   * By default, an existing file will not be overwritten. Use the overwriteExistingFile property for the
   * options parameter if you want to replace data in an existing file.
   * @param {string} node The path to the SubNodeMotion node.
   * @param {string} filePath File path for the USD or ATOM file to export transformation data to. The file type is determined from the file extension (e.g. ".usd" or ".atom")
   * @param {Object} [options={}] (Optional) An export options object with the following properties:
   * @returns {boolean}
   * @example
   * var selNode = selection.selectedNode(0);
   * var selType = node.type(selNode);
   * if (selType == "SubNodeMotion") {
   *     if (!Subnode.exportTransformations(selNode, "/assets/walk_animation.usda", {
   *             usdIncludeModelAsSublayer: true,
   *             overwriteExistingFile: true
   *         }))
  ...
  /**
   * Import transformation data from a USD (Universal Scene Description) or Autodesk Maya ATOM (Animation
   * Transfer Object Model) file into matching scene nodes.
   * @param {string} filePath File path for the USD or ATOM file to import transformation data from. The file type is determined from the file extension (e.g. ".usd" or ".atom")
   * @returns {boolean}
   */
  function importPegTransformations(filePath: string): boolean;

  /**
   * Import transformation data from USD (Universal Scene Description) or Autodesk Maya ATOM (Animation
   * Transfer Object Model) files into a SubNodeMotion node.
   * @param {string} node The path to the SubNodeMotion node.
   * @param {string} filePath File path for the USD or ATOM file to import transformation data from. The file type is determined from the file extension (e.g. ".usd" or ".atom")
   * @returns {boolean}
   * @example
   ...
   * }
   */
  function importTransformations(node: string, filePath: string): boolean;
}
 ...
 *
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/extended/module-PythonManager-PyObjectWrapper.html}
 */
 ...
 *
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/extended/ScriptToolbarDef.html}
 */
 ...
 * query.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/extended/module-Drawing.html}
 */
declare namespace Drawing {
  /**
...
declare namespace Drawing {
   ...
   * {@link https://docs.toonboom.com/help/harmony-25/scripting/extended/module-Drawing_font.html}
   */
  namespace font {
    /**
...
declare namespace Drawing {
   ...
   *
   * {@link https://docs.toonboom.com/help/harmony-25/scripting/extended/module-Drawing_geometry.html}
   */
  namespace geometry {
    /**
...
declare namespace Drawing {
   ...
   * {@link https://docs.toonboom.com/help/harmony-25/scripting/extended/module-Drawing_query.html}
   */
  namespace query {
    /**
...
declare namespace Drawing {
   ...
   * {@link https://docs.toonboom.com/help/harmony-25/scripting/extended/module-Drawing_selection.html}
   */
  namespace selection {
    /**
...
declare namespace Drawing {
   ...
   *
   * {@link https://docs.toonboom.com/help/harmony-25/scripting/extended/module-Drawing_text.html}
   */
  namespace text {
    /**
     * This function returns the text layers in the drawing identified by the drawing key and art
...
declare namespace Drawing {
   ...
   * {@link https://docs.toonboom.com/help/harmony-25/scripting/extended/module-Drawing_Text_.html}
   */
  namespace Text {
    /**
 ...
 * might end up
 *  modified.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/extended/module-DrawingTools.html}
 */
declare namespace DrawingTools {
  /**
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/extended/module-PythonManager.html}
 */
 ...
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/extended/module-ScriptManager.html}
 */
 ...
 * node in the scene.
 * {@link https://docs.toonboom.com/help/harmony-25/scripting/extended/module-Tools.html}
 */
