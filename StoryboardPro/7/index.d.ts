...
/// <reference path="../../shared/16/index.d.ts" />
...
declare class ExportManager extends QObject {
   ...
   */
  public exportToBitmap(exportDir: string, filePattern: string, bitmapFormat: BitmapFormat): boolean;

  /**
   * Export storyboard to movie file.
   */
  public exportToMovie(exportDir: string, filePattern: string, movieFormat: MovieFormat): boolean;

  /**
   * Export storyboard panels, taking into consideration the scene camera (layout )
   */
  public exportLayout(exportDir: string, filePattern: string, bitmapFormat: BitmapFormat): boolean;
   ...
   */
  public exportToFCPXML(exportFilePath: string, filePattern: string, imageFormat: ImageFormat): boolean;

  /**
   * Export storyboard to Avid Media Composer AAF format.
   */
  public exportToAAF(exportFilePath: string, filePattern: string, imageFormat: ImageFormat): boolean;
   ...
   * Export storyboard panels, taking into consideration the scene camera (layout )
   */
  public exportLayout(exportDir: string, filePattern: string, bitmapFormat: BitmapFormat, resX: int, resY: int): boolean;
...
/**
 * The FileMapper public, toNativePath( String&) will return the complete path of the passed path resolving shortcuts in windows. Will also convert the path separator to
 */
